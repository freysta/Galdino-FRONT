...
import { type Student, type Driver, type Admin } from "@/services/api";

type UserType = "student" | "driver" | "admin";
type ShiftType = "Manha" | "Tarde" | "Noite" | "Integral";
...
export default function UsuariosPage() {
  ...
  const allUsers: UserWithType[] = [
    ...
    ...(drivers?.map((d: Driver) => ({ ...d, type: "driver" as UserType })) ||
      []),
    ...(admins?.map((a: Admin) => ({
      ...a,
  ...
  const handleEdit = (user: UserWithType) => {
    ...
    form.setValues({
      ...
      city: user.city || "",
      course: user.course || "",
      shift: (user.shift as ShiftType) || "Manha",
  ...
  const totalUsers = totalStudents + totalDrivers + totalAdmins;
    ...
    <Stack gap="lg">
      <Group justify="space-between">
        <div>
          ...
          <Text c="dimmed" mt="xs">
            Cadastro e controle de todos os usuários do sistema
          </Text>
        </div>
        ...
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card withBorder padding="md">
            <Group justify="space-between">
              ...
              <IconSchool size="2rem" color="blue" />
            </Group>
          </Card>
        </Grid.Col>
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
        ...
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card withBorder padding="md">
            <Group justify="space-between">
              ...
              <IconShield size="2rem" color="red" />
            </Group>
          </Card>
        </Grid.Col>
      </Grid>
      ...
      <Tabs
        value={activeTab}
        onChange={(value) => setActiveTab((value as UserType) ?? "student")}
      >
        <Tabs.List>
